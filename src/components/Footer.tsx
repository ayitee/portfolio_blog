...
export default function Footer() {
  return (
    <footer className="mt-24 pt-16 border-t" style={{borderColor:'color-mix(in srgb, var(--color-surface-2) 35%, transparent)'}}>
      <p className="text-sm text-[var(--color-text)] opacity-60 mb-4">
        Heavily inspired by{' '}
        <a
  ...
  <Link href="/" className="font-medium text-[var(--color-text)] opacity-80 hover:opacity-100 transition-colors duration-300">
          Get in touch
        </Link>
      </p>
    </footer>
